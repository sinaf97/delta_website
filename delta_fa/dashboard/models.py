...
class User(AbstractUser):
    latin_first_name = models.CharField(max_length=30,default='')
    latin_last_name = models.CharField(max_length=30,default='')
    role = models.CharField(max_length=30)
    latin_role = models.CharField(max_length=30,default='')
...
class Teacher(models.Model):
    ...
    latin_certificate = models.CharField(max_length=64,null=True)
...
class Student(models.Model):
    ...
    def __str__(self):
        return f"{self.user.first_name} {self.user.last_name}"
    def latinFullName(self):
        return f"{self.user.latin_first_name} {self.user.latin_last_name}"
    def getStudentInfo(self):
        return {'username':self.user.username,'name':self.__str__()}
    def getStudentLatinInfo(self):
        return {'username':self.user.username,'name':self.latinFullName()}
